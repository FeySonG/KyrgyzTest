using KyrgyzTest.OldDbRegion.Models;
using Microsoft.EntityFrameworkCore;

namespace KyrgyzTest.OldDbRegion;

public partial class LegacyDbRegionContext : DbContext
{
    public LegacyDbRegionContext()
    {
    }

    public LegacyDbRegionContext(DbContextOptions<LegacyDbRegionContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=AVN_test_region;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.Property(e => e.TextEn).HasDefaultValue("");
        });

        modelBuilder.Entity<MmPole>(entity =>
        {
            entity.Property(e => e.Id).ValueGeneratedNever();
        });

        modelBuilder.Entity<OtchetBlank>(entity =>
        {
            entity.ToView("otchet_blank");
        });
        ...
        modelBuilder.Entity<PEvent>(entity =>
        {
            entity.HasKey(e => e.EventId).HasName("PK_Events");

            entity.HasOne(d => d.Account).WithMany(p => p.PEvents).HasConstraintName("FK_Events_P_Accounts");
        });
        ...
        modelBuilder.Entity<PGroup>(entity =>
        {
            ...
            entity.HasOne(d => d.Regulation).WithMany(p => p.PGroupRegulations).HasConstraintName("FK_P_Groups_Regulation");

            entity.HasOne(d => d.RegulationId2Navigation).WithMany(p => p.PGroupRegulationId2Navigations).HasConstraintName("FK_P_Groups_Regulation2");

            entity.HasOne(d => d.RegulationId3Navigation).WithMany(p => p.PGroupRegulationId3Navigations).HasConstraintName("FK_P_Groups_Regulation3");

            entity.HasOne(d => d.Test).WithMany(p => p.PGroupTests).HasConstraintName("FK_P_Groups_TestStorage");

            entity.HasOne(d => d.TestId2Navigation).WithMany(p => p.PGroupTestId2Navigations).HasConstraintName("FK_P_Groups_TestStorage1");
        });
        ...
        modelBuilder.Entity<PGroupRespondent>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.PGroupRespondents).HasConstraintName("FK_P_GroupRespondent_P_Companies");
        ...
        modelBuilder.Entity<PPaymentAccount>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.PPaymentAccounts).HasConstraintName("FK_P_PaymentAccounts_P_Companies");

            entity.HasOne(d => d.UserAccount).WithMany(p => p.PPaymentAccounts).HasConstraintName("FK_P_PaymentAccounts_P_Accounts");
        });
        ...
        modelBuilder.Entity<PPaymentOperation>(entity =>
        {
            ...
            entity.HasOne(d => d.CanceledAccount).WithMany(p => p.PPaymentOperationCanceledAccounts).HasConstraintName("FK__P_Payment__Cance__084B3915");

            entity.HasOne(d => d.Group).WithMany(p => p.PPaymentOperations).HasConstraintName("FK_P_PaymentOperations_P_Groups");
            ...
            entity.HasOne(d => d.RespondentAccount).WithMany(p => p.PPaymentOperationRespondentAccounts).HasConstraintName("FK_P_PaymentOperations_P_Accounts");

            entity.HasOne(d => d.ResponsibleAccount).WithMany(p => p.PPaymentOperationResponsibleAccounts).HasConstraintName("FK_P_PaymentOperations_P_Accounts1");
        });
        ...
        modelBuilder.Entity<PProperty>(entity =>
        {
            ...
            entity.HasOne(d => d.DefaultPropertyValue).WithMany(p => p.PProperties).HasConstraintName("FK_P_Properties_P_PropertyValues");

            entity.HasOne(d => d.ParentProperty).WithMany(p => p.InverseParentProperty).HasConstraintName("FK_P_Properties_P_Properties");
        });
        ...
        modelBuilder.Entity<PPropertyValue>(entity =>
        {
            ...
            entity.HasOne(d => d.ParentValue).WithMany(p => p.InverseParentValue).HasConstraintName("FK_P_PropertyValues_P_PropertyValues");
        ...
        modelBuilder.Entity<VBlank1>(entity =>
        {
            entity.ToView("v_blank_1");
        });

        modelBuilder.Entity<VBlank2>(entity =>
        {
            entity.ToView("v_blank_2");
        });

        modelBuilder.Entity<VBlank3>(entity =>
        {
            entity.ToView("v_blank_3");
        });

        modelBuilder.Entity<VBlank4>(entity =>
        {
            entity.ToView("v_blank_4");
        });

        modelBuilder.Entity<VBlank5>(entity =>
        {
            entity.ToView("v_blank_5");
        });

        modelBuilder.Entity<VBlank6>(entity =>
        {
            entity.ToView("v_blank_6");
        });

        modelBuilder.Entity<VBlank7>(entity =>
        {
            entity.ToView("v_blank_7");
        });

        modelBuilder.Entity<VBlank7Advanced>(entity =>
        {
            entity.ToView("v_blank_7_advanced");
        });

        modelBuilder.Entity<VStatistik>(entity =>
        {
            entity.ToView("V_statistik");
        });

        modelBuilder.Entity<VTest1>(entity =>
        {
            entity.ToView("v_test_1");
        });

        modelBuilder.Entity<VTest2>(entity =>
        {
            entity.ToView("v_test_2");
        });

        modelBuilder.Entity<VTest3>(entity =>
        {
            entity.ToView("v_test_3");
        });

        modelBuilder.Entity<VTest4>(entity =>
        {
            entity.ToView("v_test_4");
        });

        modelBuilder.Entity<VTest4Advanced>(entity =>
        {
            entity.ToView("v_test_4_advanced");
        });

        modelBuilder.Entity<VTest5>(entity =>
        {
            entity.ToView("v_test_5");
        });

        modelBuilder.Entity<VTest5Advanced>(entity =>
        {
            entity.ToView("v_test_5_advanced");
        });

        modelBuilder.Entity<VUserAnswersUpdate>(entity =>
        {
            entity.ToView("V_UserAnswers_update");
        });
