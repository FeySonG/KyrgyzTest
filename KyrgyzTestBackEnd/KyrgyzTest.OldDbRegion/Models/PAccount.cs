...
public partial class PAccount
{
    ...
    [InverseProperty("Account")]
    public virtual ICollection<PEvent> PEvents { get; set; } = new List<PEvent>();
    ...
    [InverseProperty("CanceledAccount")]
    public virtual ICollection<PPaymentOperation> PPaymentOperationCanceledAccounts { get; set; } = new List<PPaymentOperation>();
